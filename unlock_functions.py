"""this module decode the encrypted messages that were encoded from the lock command. """
...
def unlock(encrypted_msg_file):
    """this function opens the encoded text file created and restores it to it's original message. """
